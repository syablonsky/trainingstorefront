...
public class MetadataController {
    ...
    public ModelAndView metadataList() throws MetadataProviderException {
        ...
        ModelAndView model = new ModelAndView(new InternalResourceView("/WEB-INF/views/desktop/pages/saml/security/metadataList.jsp", true));
    ...
    public ModelAndView adminLogin() {
        ...
        ModelAndView model = new ModelAndView(new InternalResourceView("/WEB-INF/views/desktop/pages/saml/security/adminLogin.jsp", true));
        return model;
    ...
    public ModelAndView displayProvider(@RequestParam("providerIndex") int providerIndex) {
        ...
        ModelAndView model = new ModelAndView(new InternalResourceView("/WEB-INF/views/desktop/pages/saml/security/providerView.jsp", true));
    ...
    public ModelAndView generateMetadata(HttpServletRequest request) throws KeyStoreException {
        ...
        ModelAndView model = new ModelAndView(new InternalResourceView("/WEB-INF/views/desktop/pages/saml/security/metadataGenerator.jsp", true));
    ...
    public ModelAndView createMetadata(@ModelAttribute("metadata") MetadataForm metadata, BindingResult bindingResult) throws MetadataProviderException, MarshallingException, KeyStoreException {
        ...
        if (bindingResult.hasErrors()) {
            ModelAndView modelAndView = new ModelAndView(new InternalResourceView("/WEB-INF/views/desktop/pages/saml/security/metadataGenerator.jsp", true));
    ...
    protected ModelAndView displayMetadata(EntityDescriptor entityDescriptor, ExtendedMetadata extendedMetadata) throws MarshallingException {
        ...
        ModelAndView model = new ModelAndView(new InternalResourceView("/WEB-INF/views/desktop/pages/saml/security/metadataView.jsp", true));
