...
<jsp:include page="/WEB-INF/views/desktop/pages/saml/templates/head.jsp" />
<body>
<div id="site-wrapper">
    <jsp:include page="//WEB-INF/views/desktop/pages/saml/templates/navigation.jsp" />
    <div class="main" id="main-two-columns">
        ...
        <jsp:include page="/WEB-INF/views/desktop/pages/saml/templates/sidebar.jsp" />
    </div>
    <jsp:include page="/WEB-INF/views/desktop/pages/saml/templates/footer.jsp" />
</div>
</body>
</html>